...
export const projects: Project[] = [
    ...
    tags: ['JavaScript', 'GSAP', 'SVG Animation', 'Brand Landing Page', 'Campaign', 'Sass', 'CSS'],
    ...
    videos: [
      '/work/video/real-time-campaign-gsap-animation.mp4',
    ],
  },
  {
    ...
    tags: ['JavaScript', 'Parallax', 'Scroll Animation', 'Campaign Landing Page', 'Responsive Web Design', 'Mobile', 'GSAP'],
    filterTags: ['Animation', 'Brand Campaign'],
    ...
    thumbDark: '/work/images/covergirl-parallax-scroll-animation-thumb-dark.jpg',
    images: [
      '/work/images/covergirl-parallax-scroll-animation.png',
    ],
    videos: [
      '/work/video/covergirl-parallax-scroll-animation.mp4',
    ],
  },
...

  {
    ...
    headline: 'After-sales infrastructure built for 16 markets — Porsche LATAM.',
    tags: ['CRM Integration', 'Lead Collection', 'Email Templates', 'Component Library', 'Landing Page', 'JavaScript', 'Version Control'],
    ...
    tags: ['WordPress', 'PHP', 'JavaScript', 'Google Maps API', 'CRM Integration', 'API Integration', 'Lead Generation', 'Dealer Locator', 'Brand Website'],
    ...
    headline: 'Tournament registration built for a fishing community — Herman Lucerne.',
    tags: ['Next.js', 'Stripe', 'Zod', 'Registration Portal', 'Payment Integration', 'Nonprofit', 'Form Validation'],
    ...
    thumb: '/work/images/nextjs-stripe-tournament-registration-portal-thumb-light.jpg',
    thumbDark: '/work/images/nextjs-stripe-tournament-registration-portal-thumb-dark.jpg',
  },
    {
    ...
    tags: ['PHP', 'JavaScript', 'Lead Generation', 'CRM Integration', 'Salesforce', 'Backend Development', 'Landing Page', 'Higher Education'],
    ...
    thumb: '/work/images/higher-education-lead-generation-salesforce-thumb-light.jpg',
    thumbDark: '/work/images/higher-education-lead-generation-salesforce-thumb-dark.jpg',
    images: [
    ...
    headline: 'The story of local captains fighting for Florida\'s water — Captains for Clean Water.',
    tags: ['JavaScript', 'GSAP', 'SVG Animation', 'WordPress', 'Salesforce', 'CRM Integration', 'Nonprofit', 'Sass'],
    ...
    thumb: '/work/images/nonprofit-gsap-svg-animation-wordpress-thumb-light.jpg',
    thumbDark: '/work/images/nonprofit-gsap-svg-animation-wordpress-thumb-dark.jpg',
    videos: [
      '/work/video/nonprofit-gsap-svg-animation-wordpress.mp4',
    ],
  },

  {
    ...
    tags: ['Mobile Web App', 'Real-Time', 'Event Management', 'Mobile-First', 'Cross-Browser', 'JavaScript'],
    ...
    thumbDark: '/work/images/mobile-first-event-schedule-web-app-thumb-dark.jpg',
  },
  {
    ...
    tags: ['CMS Management', 'Solr', 'Search Architecture', 'API Integration', 'UI Development', 'Platform Migration', 'PHP', 'JavaScript'],
    filterTags: ['Platform Build', 'CRM & Data'],
    ...
    thumb: '/work/images/multi-site-cms-platform-features-maintenance-thumb-light.jpg',
    thumbDark: '/work/images/multi-site-cms-platform-features-maintenance-thumb-dark.jpg', 
  },
  {
    ...
    tags: ['Full-Stack Development', 'Real-Time Data', 'JavaScript', 'Backend Development', 'News Application', 'Data Visualization', 'Stakeholder Management'],
    ...
    thumb: '/work/images/full-stack-real-time-news-election-app-thumb-light.jpg',
    thumbDark: '/work/images/full-stack-real-time-news-election-app-thumb-dark.jpg', 
  },
  {
    slug: 'animated-gsap-banners-mercury',
    title: 'Mercury: Repower',
    headline: 'Big engine, subtle animations — Mercury Repower.',
    tags: ['HTML5 Banners', 'GSAP', 'SVG Animation', 'JavaScript', 'Animated Banners', 'Brand Campaign', 'Display Advertising'],
    filterTags: ['Animation', 'Brand Campaign'],
  ...
  },
  {
    ...
    headline: 'Making randomness feel alive — Santa Margherita Uncork Extraordinary.',
    tags: ['HTML5 Banners', 'GSAP', 'JavaScript', 'Animated Banners', 'Brand Campaign', 'Display Advertising'],
    filterTags: ['Animation', 'Brand Campaign'],
    ...
    thumb: '/work/images/santa-margherita-uncork-extraordinary-animation-thumb-light.jpg',
    thumbDark: '/work/images/santa-margherita-uncork-extraordinary-animation-thumb-dark.jpg',
    videos: [
  ...
  },
  {
    ...
    tags: ['HTML5 Banners', 'GSAP', 'JavaScript', 'Animated Banners', 'Brand Campaign', 'Display Advertising', 'Performance Optimization'],
    filterTags: ['Animation', 'Brand Campaign'],
    ...
    thumb: '/work/images/virgin-voyages-launch-campaign-animation-banners-thumb-light.jpg',
    thumbDark: '/work/images/virgin-voyages-launch-campaign-animation-banners-thumb-dark.jpg',
    videos: [
  ...
  },
  {
    ...
    tags: ['AR Filter', 'Meta Spark', 'Augmented Reality', 'Instagram', 'Social Media', 'Brand Activation'],
    ...
    thumb: '/work/images/porsche-social-augmented-reality-filter-ar-thumb-light.jpg',
    thumbDark: '/work/images/porsche-social-augmented-reality-filter-ar-thumb-dark.jpg',
    videos: [
      '/work/video/porsche-social-augmented-reality-filter.mp4',
    ],
  },
...

  {
    ...
    tags: ['Branded Landing Page', 'API Integration', 'Instagram Integration', 'User Generated Content', 'Tourism', 'Real-Time Data'],
    ...
    thumb: '/work/images/florida-tourism-landing-page-brand-repositioning-thumb-light.jpg',
    thumbDark: '/work/images/florida-tourism-landing-page-brand-repositioning-thumb-dark.jpg',
    images: [
  ...
  },
  {
    ...
    tags: ['Google Maps API', 'Branded Landing Page', 'API Integration', 'Event Website'],
    filterTags: ['Brand Campaign', 'Platform Build'],
    ...
    thumb: '/work/images/event-landing-page-brand-repositioning-thumb-light.jpg',
    thumbDark: '/work/images/event-landing-page-brand-repositioning-thumb-dark.jpg',
  },

  {
    ...
    tags: ['HTML Email', 'Email Templates', 'CRM Integration', 'Salesforce', 'Modular Templates', 'Direct Marketing', 'Cross-Client Compatibility'],
    filterTags: ['CRM & Data'],
    ...
    thumb: '/work/images/html-email-templates-crm-marketing-integration-thumb-light.jpg',
    thumbDark: '/work/images/html-email-templates-crm-marketing-integration-thumb-dark.jpg',    
  },
  {
    slug: 'full-lifecycle-wordpress-cms-management',
    title: 'CMS Management',
    headline: 'Full-lifecycle CMS management across major brands.',
    tags: ['WordPress', 'CMS Management', 'Content Management', 'WordPress Development', 'Website Maintenance', 'Feature Development'],
    filterTags: ['WordPress', 'CRM & Data'],
    ...
    thumb: '/work/images/full-lifecycle-wordpress-cms-management-thumb-light.jpg',
    thumbDark: '/work/images/full-lifecycle-wordpress-cms-management-thumb-dark.jpg',    
  },
  {
    slug: 'devops-architecture-aws-cloudflare-security',
    title: 'DevOps Architecture & Operations',
    headline: 'The infrastructure behind the work — DevOps Architecture & Operations.',
    tags: ['DevOps', 'CI/CD', 'Git', 'Webpack', 'Vite', 'AWS', 'Vercel', 'Cloudflare', 'Security', 'Infrastructure'],
    filterTags: ['DevOps'],
    ...
    thumb: '/work/images/devops-architecture-aws-cloudflare-security-thumb-light.jpg',
    thumbDark: '/work/images/devops-architecture-aws-cloudflare-security-thumb-dark.jpg', 
  },
